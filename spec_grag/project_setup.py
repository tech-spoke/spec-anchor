...
context_max_source_constraints = 8
context_max_related_sources = 8
context_max_entities = 8
context_max_review_notes = 12
context_max_conflict_notes = 8
context_max_classification_notes = 6
