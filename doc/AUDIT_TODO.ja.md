...
- [~] Claude architecture audit 指摘の current HEAD 突き合わせ（2026-05-03）
  ...
  - 継続課題: `injection.py` / `core.py` 分割、atomic write / LLM factory 共通化、logging 導入、tests/conftest.py 整理、dense search の numpy/Qdrant 化、safe_delete_by_sections batch 化、watcher / foreground lock 方針確認
