...
|---|---|---|---|---|---|---|
| 1 | T-draft-display-contract | §8.7 人間向け表示契約（停止カテゴリ枠組み・禁止内部用語・正常完了・リトライ）を draft へ反映 | 未着手 | — | 2026-05-30 | — |
| 2 | T-draft-active-search | §8.3 / §8.3.1 の能動的 Agentic Search 文言を draft §2.10 / §6.2 へ反映 | 未着手 | — | 2026-05-30 | — |
| 3 | T-draft-japanese-check | draft の利用者向け出力例に英語自然文が残っていないか確認・是正 | 未着手 | — | 2026-05-30 | — |
