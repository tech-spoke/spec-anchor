...
heading_path / source_hash / semantic_hash) lives on the `spec_anchor_section`
...
`spec_anchor/retrieval_index.py` is the contract. This module normalizes
...
from spec_anchor.retrieval_index import DEFAULT_SECTION_COLLECTION
...
def fetch_section_payloads(
    ...
    *,
    ...
    must be the section-level collection (default `spec_anchor_section`).
    """
