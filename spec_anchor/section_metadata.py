...
from spec_anchor.config import (
    LimitsConfig,
...
_CLI_COMMAND_RE = re.compile(
    r"\b(?:spec-anchor(?:-[A-Za-z0-9_-]+)?|codex|claude)"
...
def build_related_section_candidates(
    ...
    *args: Any,
    ...
    from spec_anchor.related_sections import build_related_section_candidates as _build
...
def validate_related_sections(
    ...
    *args: Any,
    ...
    from spec_anchor.related_sections import validate_related_sections_result as _validate
...
def select_related_sections(
    ...
    *args: Any,
    ...
    from spec_anchor.related_sections import select_related_sections_result as _select
...
def related_section_reevaluation_targets(
    ...
    *args: Any,
    ...
    from spec_anchor.related_sections import (
