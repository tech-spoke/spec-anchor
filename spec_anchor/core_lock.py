"""Shared lock helpers for SPEC-anchor core artifact updates."""
...
DEFAULT_CORE_LOCK_FILE = ".spec-anchor/state/core_update.lock.json"
...
def _holder_process_dead(lock_payload: Mapping[str, Any]) -> bool:
    ...
    (``holder_hostname`` matches) so cross-host locks (rare for spec-anchor) are
    not falsely cleared.
    """
