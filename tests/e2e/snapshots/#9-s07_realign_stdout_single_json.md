# #9-s07 CLI stdout = valid JSON single object

検証コマンド: `spec-anchor realign --answer-text "暫定回答"` を `.spec-anchor/config.toml` が無い空プロジェクトで実行。
...
```json
{
  ...
  "error": {
    "code": "command_error",
    "message": ".spec-anchor/config.toml not found under /tmp/claude-1001/tmpwjf596hz",
    "type": "ConfigError"
  },
  "project_root": "/tmp/claude-1001/tmpwjf596hz",
  "should_stop": true,
  "status": "error",
  "stops": true
}
