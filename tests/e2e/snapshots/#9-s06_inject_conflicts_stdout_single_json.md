# #9-s06 CLI stdout = valid JSON single object

検証コマンド: `spec-anchor inject-conflicts` を `.spec-anchor/config.toml` が無い空プロジェクトで実行。
...
```json
{
  ...
  "error": {
    "code": "command_error",
    "message": ".spec-anchor/config.toml not found under /tmp/claude-1001/tmp7sxoiu89",
    "type": "ConfigError"
  },
  "project_root": "/tmp/claude-1001/tmp7sxoiu89",
  "should_stop": true,
  "status": "error",
  "stops": true
}
