# #9-s03 CLI stdout = valid JSON single object

検証コマンド: `spec-anchor inject-section 0001-some-section` を `.spec-anchor/config.toml` が無い空プロジェクトで実行。
...
```json
{
  ...
  "error": {
    "code": "command_error",
    "message": ".spec-anchor/config.toml not found under /tmp/claude-1001/tmpingzc_aj",
    "type": "ConfigError"
  },
  "project_root": "/tmp/claude-1001/tmpingzc_aj",
  "should_stop": true,
  "status": "error",
  "stops": true
}
