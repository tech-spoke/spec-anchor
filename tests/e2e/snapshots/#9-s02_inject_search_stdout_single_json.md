# #9-s02 CLI stdout = valid JSON single object

検証コマンド: `spec-anchor inject-search "example query"` を `.spec-anchor/config.toml` が無い空プロジェクトで実行。
...
```json
{
  ...
  "error": {
    "code": "command_error",
    "message": ".spec-anchor/config.toml not found under /tmp/claude-1001/tmpu0d6_2pn",
    "type": "ConfigError"
  },
  "project_root": "/tmp/claude-1001/tmpu0d6_2pn",
  "should_stop": true,
  "status": "error",
  "stops": true
}
