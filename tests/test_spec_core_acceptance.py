...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            *case,
            marks=[pytest.mark.spec_ref("§7.1", case[0], profile="fake", method="入出力比較")],
...
@pytest.mark.spec_ref("§7.1", 579, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.1", 580, profile="fake", method="入出力比較")
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            *case,
            marks=[pytest.mark.spec_ref("§7.2", case[0], profile="fake", method="入出力比較")],
            id=f"L{case[0]}",
        )
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            *case,
            marks=[pytest.mark.spec_ref("§7.3", case[0], profile="fake", method="tool call trace 監査")],
...
@pytest.mark.spec_ref("§7.3", 639, profile="fake", method="tool call trace 監査")
...
@pytest.mark.spec_ref("§7.3", 641, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.3", 642, profile="fake", method="tool call trace 監査")
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            *case,
            marks=[pytest.mark.spec_ref("§7.4", case[0], profile="fake", method="入出力比較")],
            id=f"L{case[0]}-{case[1]}",
        )
...
@pytest.mark.spec_ref("§7.4", 674, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 676, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 677, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 678, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 679, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 686, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 688, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 689, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 690, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 691, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 693, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 694, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 696, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 697, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 724, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 726, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 727, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 728, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 729, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 730, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 755, profile="fake", method="tool call trace 監査")
...
@pytest.mark.spec_ref("§7.4", 756, profile="fake", method="入出力比較")
...
@pytest.mark.spec_ref("§7.4", 757, profile="fake", method="入出力比較")
