...
- 2026-05-03 再評価:
  ...
  - 2026-05-03 Phase 15 再実測: BM25 strong-term candidate prune 後、query set 5本は全件 `status=ok`、`high_priority_skipped_count=0` / `medium_priority_skipped_count=0` / `low_priority_skipped_count=0`
  - artifacts: q1 `.spec-grag/runs/20260502T170546.926309Z-spec-inject-381534a0c3c9.json`、q2 `.spec-grag/runs/20260502T170559.088059Z-spec-inject-005eb476cf79.json`、q3 `.spec-grag/runs/20260502T170603.362162Z-spec-inject-b4086be74f39.json`、q4 `.spec-grag/runs/20260502T170609.337073Z-spec-inject-4d291512f715.json`、q5 `.spec-grag/runs/20260502T170620.770124Z-spec-inject-d46833fc2057.json`
  - BM25 candidate documents: q1 `387 -> 227`、q2 `339 -> 245`、q3 `314 -> 281`、q4 `404 -> 69`、q5 `360 -> 53`
  - 残 finding: q4 / q5 は broad candidate 幅が大きく改善。q1〜q3 はまだ 227〜281/407 と広めなので、Source evidence の再読と field weighting / required term gate は後続で見る
...
- [ ] Phase 15 architecture audit hardening を進める
  ...
  - 2026-05-03 実装済み: atomic write 共通化、LLM factory 共通化、priority constants、`tests/conftest.py`、`safe_delete_by_sections`、optional numpy dense similarity、Concept index embedding reuse、BM25 strong-term candidate prune、staging prepare diagnostics、`[logging]` config / watcher file logging、foreground core update の `WatchLock` 共有、inject / realign 共通 pipeline 抽出
  - 先行残: `injection.py` concern 分割、`core.py` stage 分割、q1〜q3 の BM25 broad candidate 追加絞り込み検討
  - 検証: focused regression `32 passed in 15.23s`、追加 focused regression `67 passed in 69.05s`、Concept / retrieval focused `19 passed in 12.27s`、CLI focused `26 passed in 59.47s`、timing focused `4 passed in 13.48s`、full regression `246 passed in 201.30s`
