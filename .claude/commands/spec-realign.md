...
9. CLI で検証する: `spec-anchor realign "$TASK" --constraints '<json-array>' --answer-json '<json-object>'`。返却 payload を constraint-checked answer として扱う。検証に失敗した場合、answer を直すか blocker として報告する。
